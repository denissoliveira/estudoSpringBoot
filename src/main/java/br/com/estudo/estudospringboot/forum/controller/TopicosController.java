...
import br.com.estudo.estudospringboot.forum.controller.dto.DetalhesDoTopicoDto;
import br.com.estudo.estudospringboot.forum.controller.dto.TopicoDto;
import br.com.estudo.estudospringboot.forum.controller.form.AtualizacaoTopicoForm;
import br.com.estudo.estudospringboot.forum.controller.form.TopicoForm;
...
public class TopicosController {
	...
	public ResponseEntity<TopicoDto> atualizar(@PathVariable Long id, @RequestBody @Valid AtualizacaoTopicoForm form) {
		...
		if(optional.isPresent()) {
			Topico topico = form.atualizar(id, optional.get()); //JPA já atualiza automático
